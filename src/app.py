...
class Steganography:      
    ...
    def define_app_content(self):
        ...
        self.padlock_green = tk.Button(self.window, width = 30, height = 35, background="black", borderwidth=0, image = self.encrypt_button_image, activebackground="black", command=self.change_to_encrypt)
        self.padlock_green.place(x=750,y=25)
        self.padlock_red = tk.Button(self.window, width = 65, height = 35, background="black", borderwidth=0, image = self.decrypt_button_image, activebackground="black", command=self.change_to_decrypt)
